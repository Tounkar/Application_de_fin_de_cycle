		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form method="POST" action="{{ url('inscription/livreur')}}">
						@csrf
						<div class="input-group mb-2">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-user"></i></span>
							</div>
							<input type="text" name="nom" placeholder="Nom d'utilisation" class="form-control">
						...
						<div class="input-group mb-2">
							...
							<input type="password" name="mot_de_passe_confirmation" placeholder="Mot de passe" class="form-control">
						</div>
						<div class="input-group mb-2">
							<div class="input-group-append">
								<span class="input-group-text"><i class="fas fa-key"></i></span>
							</div>
							<input type="password" name="mot_de_passe" placeholder="Confirmer" class="form-control">
